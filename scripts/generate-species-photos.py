...
FISH = {
    ...
    "branzino":    ("species-branzino.webp",    "branzino (European sea bass) with a slender bright silver body, a single spiny dorsal fin, and a small pointed head"),
    "snapper":     ("species-snapper.webp",     "red snapper with rosy pinkish-red skin and fins, a sloped forehead, a pointed snout and a reddish eye"),
    "grouper":     ("species-grouper.webp",     "grouper with a stout mottled brown-grey body, a very large mouth and thick rounded fins"),
    "cod":         ("species-cod.webp",         "Atlantic cod with an olive-brown speckled body, a pale curved lateral line, a small chin barbel and three dorsal fins"),
    "halibut":     ("species-halibut.webp",     "halibut, a large elongated flatfish with both eyes on the dark grey-brown upper side and a narrow diamond-shaped body"),
    "flounder":    ("species-flounder.webp",    "flounder, a smaller oval flatfish with a brown mottled upper side and faint darker spots"),
